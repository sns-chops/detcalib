...
# difc = np.load("./C60-difc-2-B24.npy")
# mask = np.load("./C60-difc-2-B24-mask.npy")
difc = np.load("./Si_and_C60-difc-3-B24.npy")
mask = np.load("./Si_and_C60-difc-3-B24-mask.npy")
...
# long packs are of type "eightpack"
